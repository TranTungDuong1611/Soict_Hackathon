...
folder_name = 'dataset/original/public_test'
...
for filename_path in sorted(filenames_night):
    if 'src_2_frame' in os.path.basename(filename_path):
        img_dark_night_path = os.path.join(folder_path, 'dataset/original/enhanced_images', os.path.basename(filename_path))
        img_dark_night_paths.append(img_dark_night_path)
    else:
        img_night_path = os.path.join(folder_path, 'dataset/original/enhanced_gamma_images', os.path.basename(filename_path))
